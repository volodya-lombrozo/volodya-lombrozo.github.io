...
\begin{itemize}
    \itemsep0em
    \item Designed and implemented a profiling module of the monitoring system, processing 10M+ metrics daily across JVM-based cloud services, improving mean time to detect production issues.
    \item Developed core components of the \href{https://github.com/objectionary/eo}{EO} programming language,
        contributing to a novel approach in object-oriented programming that has been adopted by more than 1.3k open-source contributors;
    \item Created a disassembler and decompiler from JVM bytecode to EO language, enabling interoperability between JVM-based languages and EO programs;
    \item Authored 2 peer-reviewed scientific articles and 2 patents on programming language design, contributing to advancements in compiler optimization research;
\end{itemize}
...
\begin{itemize}
    \itemsep0em
    \item Designed and developed 6 enterprise-wide information systems in Java, helping businesses automate operations and improve efficiency;
    \item Architected and implemented core components of a high-performance distributed system (using microservices,) serving 10K+ global users with 99.95\% uptime and sub-200ms average response latency;
    \item Built 250+ CI/CD pipelines, enabling fully automated deployments, reducing release cycles from weekly to daily, and improving system stability by minimizing human error;
    \item Led architecture decisions for 6 systems, overseeing the complete development lifecycle and ensuring technical alignment with business objectives.
\end{itemize}
